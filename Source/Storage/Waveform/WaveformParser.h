...
#ifndef NUCLEX_AUDIO_STORAGE_WAVEFORM_WAVEFORMPARSER_H
#define NUCLEX_AUDIO_STORAGE_WAVEFORM_WAVEFORMPARSER_H
...
namespace Nuclex { namespace Audio { namespace Storage { namespace Waveform {
  ...
  class WaveformParser {
    ...
    public: WaveformParser(Nuclex::Audio::TrackInfo &target);
    ...
    public: bool IsComplete() const {
      ...
      return (
        // this->factChunkParsed && // see comment above
    ...
    /// <summary>Returns the number of bytes per audio frame</summary>
    /// <returns>The number of bytes per audio frame</returns>
    public: std::size_t CountBytesPerFrame();

    /// <summary>Returns the absolute offset of the audio samples in the file</summary>
    /// <returns>The absolute offset, in bytes, of the audio data in the file</returns>
    public: std::uint64_t GetAudioDataOffset();

    /// <summary>Counts the total number of audio frames in the file</summary>
    /// <returns>The total numebr of audio frames in the file</returns>
    public: std::uint64_t CountFrames();
...
#endif // NUCLEX_AUDIO_STORAGE_WAVEFORM_WAVEFORMPARSER_H
