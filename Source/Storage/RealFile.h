...
#ifndef NUCLEX_AUDIO_STORAGE_REALFILE_H
#define NUCLEX_AUDIO_STORAGE_REALFILE_H
...
namespace Nuclex { namespace Audio { namespace Storage {
  ...
  class RealFile : public VirtualFile {
    ...
    public: void ReadAt(
      std::uint64_t, std::size_t byteCount, std::byte *buffer
    ) const override;
...
#endif // NUCLEX_AUDIO_STORAGE_REALFILE_H
