...
#ifndef NUCLEX_AUDIO_STORAGE_VORBIS_VORBISAUDIOCODEC_H
#define NUCLEX_AUDIO_STORAGE_VORBIS_VORBISAUDIOCODEC_H
...
namespace Nuclex { namespace Audio { namespace Storage { namespace Vorbis {
  ...
  class VorbisAudioCodec : public AudioCodec {
    ...
    public: VorbisAudioCodec() = default;

    /// <summary>Frees all resources held by the audio codec</summary>
    public: ~VorbisAudioCodec() override = default;
...
#endif // NUCLEX_AUDIO_STORAGE_VORBIS_VORBISAUDIOCODEC_H
