...
#ifndef NUCLEX_AUDIO_PLATFORM_LINUXFILEAPI_H
#define NUCLEX_AUDIO_PLATFORM_LINUXFILEAPI_H
...
namespace Nuclex { namespace Audio { namespace Platform {
  ...
  class LinuxFileApi {
    ...
    public: static std::uint64_t StatFileSize(int fileDescriptor);
...
#endif // NUCLEX_AUDIO_PLATFORM_LINUXFILEAPI_H
