...
#ifndef NUCLEX_AUDIO_PROCESSING_LITTLEENDIANSAMPLECONVERTER_H
#define NUCLEX_AUDIO_PROCESSING_LITTLEENDIANSAMPLECONVERTER_H
...
namespace Nuclex { namespace Audio { namespace Processing {
  ...
  /// <remarks>
  /// </remarks>
  class NUCLEX_AUDIO_TYPE LittleEndianSampleConverter : SampleConverter {
